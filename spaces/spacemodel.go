...
/*spaceList*/
func SpaceList(tblspace *[]TblSpacesAliases, langId int, limit int, offset int, filter Filter, spaceid []int, DB *gorm.DB) (spacecount int64, err error) {
...
/*get default lang id*/
func GetDefaultLanguage(default_lang *TblLanguage, DB *gorm.DB) error {
...
/*Create Space*/
func CreateSpace(tblspaces *TblSpaces, DB *gorm.DB) (*TblSpaces, error) {
...
/*Create space*/
func CreateSpacesAliases(tblspace *TblSpacesAliases, DB *gorm.DB) error {
...
func ClonePage(page *TblPage, DB *gorm.DB) (*TblPage, error) {
...
func ClonePages(pages *TblPageAliases, DB *gorm.DB) error {
...
func CloneSpaceInPagesGroup(group *TblPagesGroup, DB *gorm.DB) (*TblPagesGroup, error) {
...
func ClonePagesGroup(pagegroup *TblPagesGroupAliases, DB *gorm.DB) error {
...
/*Update Space*/
func EditSpace(tblspace *TblSpacesAliases, id int, DB *gorm.DB) error {
...
/*Update Space*/
func UpdateSpace(tblspace *TblSpaces, id int, DB *gorm.DB) error {
...
/*Deleted space*/
func DeleteSpaceAliases(tblspace *TblSpacesAliases, id int, DB *gorm.DB) error {
...
/*Deleted space*/
func DeleteSpace(tblspace *TblSpaces, id int, DB *gorm.DB) error {
...
func GetPageCategoryTree(id int, DB *gorm.DB) ([]TblPagesCategoriesAliases, error) {
...
func GetParentPageCategory(pagecategory *TblPagesCategoriesAliases, page_category_id int, DB *gorm.DB) (error, TblPagesCategoriesAliases) {
...
func GetChildPageCategories(pagecategory *[]TblPagesCategoriesAliases, parent_id int, DB *gorm.DB) (error, []TblPagesCategoriesAliases) {
...
func GetSpacesData(spaces *[]TblSpaces, id int, DB *gorm.DB) error {
...
func GetPageData(page *[]TblPageAliases, id int, DB *gorm.DB) error {
...
func GetPageGroupData(group *[]TblPagesGroupAliases, id int, DB *gorm.DB) error {
...
func GetIdInPage(pageid *TblPagesGroupAliases, spaceid int, DB *gorm.DB) error {
...
func GetPageInPage(pageid *[]TblPageAliases, spaceid int, DB *gorm.DB) error {
...
func GetDetailsInPageAli(pagedetails *TblPagesGroupAliases, groupname string, spaceid int, DB *gorm.DB) error {
...
func GetDetailsInPageAlia(pageid *TblPagesGroupAliases, pagegroupid int, spaceid int, DB *gorm.DB) error {
...
func GetPageAliasesInPage(data *[]TblPageAliases, spacid int, DB *gorm.DB) error {
...
func GetPageAliasesInPageData(result *[]TblPageAliases, spacid int, DB *gorm.DB) error {
...
func LastLoopAliasesInPage(data *TblPageAliases, pagetitle string, spacid int, DB *gorm.DB) error {
...
func AliasesInParentId(data *TblPageAliases, parentid int, spacid int, DB *gorm.DB) error {
...
func ParentWithChild(parent *TblPage, id int, spaceid int, DB *gorm.DB) error {
...
func PageParentCategoryList(pagecategory *[]TblPagesCategoriesAliases, DB *gorm.DB) error {
...
/*spacename*/
func GetSpaceName(TblSpacesAliases *TblSpacesAliases, spaceid int, DB *gorm.DB) error {
...
func GetPageDetailsBySpaceId(getpg *[]TblPage, id int, DB *gorm.DB) (*[]TblPage, error) {
...
func DeletePageInSpace(page *TblPage, id []int, DB *gorm.DB) error {
...
func DeletePageAliInSpace(pageali *TblPageAliases, id []int, DB *gorm.DB) error {
...
func GetSpaceDetails(tblspace *TblSpaces, id int, DB *gorm.DB) error {
